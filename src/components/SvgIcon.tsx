...
const textColorIcon = (color: string) => (
  <svg 
    aria-hidden="true"
    className="svg-icon"
    ...
    style={css}
  >
    <line stroke={color || 'currentColor'} fill='none' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' x1="3" x2="15" y1="15" y2="15"></line>
    <polyline stroke='currentColor' fill='none' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' points="5.5 11 9 3 12.5 11"></polyline>
    <line stroke='currentColor' fill='none' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' x1="11.63" x2="6.38" y1="9" y2="9"></line>
  </svg>
);

const backgroundColorIcon = (color: string) => (
  <svg 
  aria-hidden="true"
  className="svg-icon"
  ...
  >
    <g fill={color || 'currentColor'} fillOpacity='1'>
      ...
      <polygon points="4 11.439 4 11 3 11 3 12 3.755 12 4 11.439">
        </polygon><rect height="1" width="1" x="2" y="12"></rect>
      ...
      <polyline stroke='currentColor' fill='none' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' points="5.5 13 9 5 12.5 13"></polyline>
      <line stroke='currentColor' fill='none' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' x1="11.63" x2="6.38" y1="11" y2="11"></line>
    </svg>
);
...
const SvgIcon = (props: any) => {
  ...
  switch (icon) {
    ...
    case 'text-color':
      return textColorIcon(props.additionalProps?.color);
    case 'background-color':
      return backgroundColorIcon(props.additionalProps?.color);
    default:
      return null;
  }
};
